...
public class Request {
    ...
    @Setter(AccessLevel.NONE)
    @Getter(AccessLevel.NONE)
    private final String AUTHORIZATION = "Authorization: Basic ";
    ...
    private void buildRequest(BufferedReader inputStream) {
        try {
            ...
            if (line != null) {
                ...
                setPathVar(getPathVarFromInputLine());
                ...
                while (!line.isEmpty()) {
                    ...
                    if (line.startsWith(AUTHORIZATION)) {
                        setAuthToken(getAuthTokenFromInputLine(line));
                    }
                }
    ...
    private String getAuthTokenFromInputLine(String line) {
